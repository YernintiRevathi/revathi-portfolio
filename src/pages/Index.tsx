...
const Index = () => {
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <main>
        {/* --- HERO SECTION: MODIFIED FOR BACKGROUND IMAGE & STYLING --- */}
        <section 
          id="home" 
          ...
          <div className="container px-4 relative">
            <div className="max-w-4xl mx-auto flex flex-col items-center gap-8 md:flex-row md:items-center md:gap-12">
              ...
              <div className="flex flex-col items-center md:items-start">
                {/* Fixed the gradient and added padding to prevent text cutoff */}
        ...
        <div className="container px-4">
            <div className="text-center mb-12">
              {/* Added gradient to this heading for consistency */}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                {/* --- CONTACT SECTION: UPDATED ICON COLORS TO MATCH THEME --- */}
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      <Mail className="h-5 w-5 text-primary" /> {/* Themed Color */}
                      Email
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      <Linkedin className="h-5 w-5 text-primary" /> {/* Themed Color */}
                      LinkedIn
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      <Github className="h-5 w-5 text-foreground/80" /> {/* Themed Color */}
                      GitHub
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      <MapPin className="h-5 w-5 text-secondary" /> {/* Themed Color */}
                      Location
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
