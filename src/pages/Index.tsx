          ...
          <div className="container px-4">
            <div className="max-w-4xl mx-auto flex flex-col items-center gap-8 md:flex-row md:items-center md:gap-12">
              ...
              <div className="flex flex-col items-center md:items-start">
                <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-primary via-secondary to-vibrant bg-clip-text text-transparent flex-shrink-0 pl-7">
                  Revathi Yerninti
                </h1>
